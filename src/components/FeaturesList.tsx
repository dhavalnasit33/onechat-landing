...
const featuresData: Feature[] = [
  {
    ...
    description:
      "GPT, Claude, Gemini, and more — all in one place, with no need to juggle multiple subscriptions.",
    bullets: [
    ...
    imagePath: "/assets/landing-page/access-every-model-section-1.png",
  ...
  },
  {
    ...
    description:
      "Turn words into stunning visuals — generate, edit, and enhance any image with AI in seconds.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Create professional videos from a script or idea — no camera, no crew, no editing skills required.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "From first draft to final publish — AI writing tools for every format, every platform, every audience.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Ask one question, see how every AI answers it. Pick the best response or combine insights from multiple models.",
    bullets: [
    ...
    videoPath:
      "/assets/landing-page/compare-ai-models-side-by-side-section-2.mp4",
  ...
  },
  {
    ...
    description:
      "Change models mid-conversation without losing context or breaking your flow.",
    bullets: [
  ...
  },
  {
    ...
    title: "Design & Media",
    description:
      "Create professional visuals in seconds — no design skills, no studio, no expensive software required.",
    bullets: [
  ...
  return (
    <section id="features" className="w-full py-20 md:py-32 bg-white px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-24 flex flex-col px-2 gap-20 sm:gap-20 lg:gap-24">
          {featuresData.map((feature, idx) => {
            ...
            return (
              <div
                key={feature.section}
                className={`flex flex-col lg:flex-row items-center gap-8 lg:gap-16 border-b border-brand-border/40 pb-20 sm:pb-28 lg:pb-32 last:border-0 ${
                  isReversed ? "lg:flex-row-reverse" : ""
                }`}
              >
                {/* Visual Block: Video Player or Image with Background Glow */}
                ...
                {/* Description Block */}
                <div className="w-full lg:w-1/2 flex flex-col justify-center items-start text-left max-w-[550px] lg:max-w-none mx-auto lg:mx-0">
                  <h3 className="font-poppins text-2xl md:text-3xl font-extrabold text-brand-dark tracking-tight leading-tight text-left">
                    {feature.title}
                  </h3>

                  <p className="mt-4 font-sans text-sm sm:text-base text-brand-slate font-medium leading-relaxed max-w-[480px] text-left">
                    {feature.description}
                  </p>

                  {/* Bullet points */}
                  <ul className="mt-6 flex flex-col gap-4 max-w-[480px] text-left">
                    {feature.bullets.map((bullet, bIdx) => {
                      const parts = bullet.split(" — ");
                      return (
                        <li
                          key={bIdx}
                          className="flex items-start gap-3 text-sm text-brand-slate leading-relaxed"
                        >
